...
describe('DocPreviewURLs', function() {
    ...
    it("create", function() {
        ...
        assert.equal(DocPreviewURLs.create({hashcode: '12345'}), "https://app.getpolarized.io/d/0x12345");

        assert.equal(DocPreviewURLs.create({hashcode: '12345', title: 'hello world'}), 'https://app.getpolarized.io/d/hello%20world/0x12345');

        assert.equal(DocPreviewURLs.create({hashcode: '12345', category: 'test', title: 'hello world'}), 'https://app.getpolarized.io/d/test/hello%20world/0x12345');
